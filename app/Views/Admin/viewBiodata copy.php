        ...
        <div class="card card-default">
          <div class="card-header d-flex p-0">
            ...
            <ul class="nav nav-pills ml-auto p-2">
              <a href="#" class="nav-link bg-pink tomboledit" onclick=edit(<?= $siswa["nisn"] ?>)><i class=" fas fa-pencil-alt"></i> Edit Biodata</a>
            </ul>
          </div>
          <!-- /.card-header -->
          <p class="viewdata">
  ...
  function edit(nisn) {
    $.ajax({
      ...
      complete: function() {
        ...
        $(".tomboledit").attr("onclick", "ambilnisn()");

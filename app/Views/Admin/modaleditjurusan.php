<div class="modal fade" id="modaleditjurusan">
    <div class="modal-dialog modal-default">
        <div class="modal-content">
            ...
            <?= form_open("Admin/updatejurusan", ["class" => "formjurusan"]) ?>
            <?= csrf_field(); ?>
            <div class="modal-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        ...
                        <input type="text" class="form-control" placeholder="Masukkan Nama Jurusan" name="nama_jurusan" id="nama_jurusan" value="<?= $nama_jurusan ?>">

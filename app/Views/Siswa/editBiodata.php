<?= form_open("Siswa/updatebiodata", ["class" => "formbiodata"]) ?>
<?= csrf_field(); ?>
<div class="card-body">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <input type="number" class="form-control" placeholder="Masukkan NIS Siswa" value="<?= $siswa[0]["nis"] ?>" readonly>
        </div>
    </div>
    <div class="form-group row">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <input type="text" class="form-control" placeholder="Masukkan Kelas Siswa" value="<?= $siswa[0]["tahun_masuk"] ?>" readonly>
        </div>
    </div>
    <div class="form-group row">
